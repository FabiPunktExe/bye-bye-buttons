...
/** This mixin removes the player reporting button from the pause screen */
@Mixin(PauseScreen.class)
public class PauseScreenPlayerReportingButtonMixin {
    @WrapOperation(
    ...
    public <T extends LayoutElement> T removeButton(LinearLayout instance, T child, Operation<T> original) {
        if (ByeByeButtonsConfig.PAUSE_SCREEN_PLAYER_REPORTING_BUTTON.get()) {
