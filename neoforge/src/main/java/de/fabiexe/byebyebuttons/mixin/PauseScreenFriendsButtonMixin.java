...
/** This mixin removes the friends button from the pause screen */
@Mixin(PauseScreen.class)
public class PauseScreenFriendsButtonMixin {
    @WrapOperation(
    ...
    public <T extends LayoutElement> T removeButton(LinearLayout instance, T child, Operation<T> original) {
        if (ByeByeButtonsConfig.PAUSE_SCREEN_FRIENDS_BUTTON.get()) {
